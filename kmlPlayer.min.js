...
/*! videojs-subtitle - v0.0.0 - 2016-05-18
* Copyright (c) 2016 Lacatusu Mihai Daniel; Licensed Apache-2.0 */
!function(a,b){"use strict";var c,d,e={minFont:1,ratioFont:2,offset:30},f=null,g=[],h=!0,i=null,j=function(a){for(var b=0;b<g.length;b+=1){var c=g[b].start,e=g[b].end;a>=c&&e>=a?f!=b&&(f=b,d.textTrackDisplay?d.textTrackDisplay.removeClass("vjs-hidden"):null,i.style.display="inline-block",i.innerHTML="<span>"+g[b].text+"</span>",h=!1):f==b&&(h||(d.textTrackDisplay?d.textTrackDisplay.addClass("vjs-hidden"):null,i.innerHTML="",i.style.display="none",h=!0,f=null))}},k=function(a){var b=a.ratioFont*d.bounds().width/1e3;return b<a.minFont&&(b=a.minFont),b},l=function(){j(d.currentTime())},m=function(){i.innerHTML="",i.style.display="none"},n=function(){f=null,h=!0,g=[];for(var a=d.tech_.el_.querySelectorAll("track"),b=0;b<a.length;b+=1)d.tech_.el_.removeChild(a[b])};c=function(a,c){function f(){d.textTrackDisplay.el_.responsive?d.textTrackDisplay.el_.responsive.enable():d.responsive(d.textTrackDisplay.el_,{x:0,y:0,height:d.videoHeight()-r.offset,width:"100%",callback:function(){i.style.fontSize=k(r)+"em"}})}function h(a){var b=0;if(a)for(var c=a.split(":"),d=0;d<c.length;d++)b=60*b+parseFloat(c[d].replace(",","."));return b}function o(a){return a.replace(/^\s+|\s+$/gm,"")}function p(a){if(!a)return[];for(var b=a.split(/\r|\n|\r\n/),c=[],d={},e=0,f=b.length;f>e;e++){var g=b[e];if(void 0!==d.start||void 0!==d.end){var i=o(g);""===i?(d.text&&(d.text=d.text.join("<br/>"),c.push(d)),d={}):(d.text||(d.text=[]),d.text.push(i))}else{var j=g.split("-->");j.length>1&&(d.start=h(j[0]),d.end=h(j[1]))}}return c}function q(){g.length>0?(d.paused()&&j(d.currentTime()),d.on("timeupdate",l),d.on("ended",m),d.textTrackDisplay.el_.style.display="block",f()):d.textTrackDisplay.el_.style.display="none"}var r=b.mergeOptions(e,c);if(d=this,n(),null===i){var s=document.createElement("div"),t=document.createElement("div");if(s.className="vjs-text-track-wrap",t.className="vjs-text-track-text",s.appendChild(t),d.textTrackDisplay&&d.textTrackDisplay.el_.children[0])i=d.textTrackDisplay.el_.children[0];else{var u=document.createElement("div");u.className="vjs-text-track-holder",d.textTrackDisplay.el_.appendChild(u),i=u}i.style.margin="1.5% 0",i.style.top="auto",i.appendChild(s),i=t,i.style.display="none"}d.textTrackDisplay.el_.responsive&&d.textTrackDisplay.el_.responsive.disable(),d.off(d.player_,"timeupdate",l),d.off(d.player_,"ended",m),d.textTrackDisplay.el_.className="vjs-text-track-display",i.innerHTML="",a?a instanceof Array?(g=a,q()):(d.addClass("vjs-waiting"),d.ajax.get(a).success(function(a,b){g=p(a),q(),d.removeClass("vjs-waiting")}).error(function(a,b){d.textTrackDisplay.el_.style.display="none",d.removeClass("vjs-waiting")})):d.textTrackDisplay.el_.style.display="none"},b.plugin("subtitle",c)}(window,window.videojs);
/**
 * videojs-visibility
 * @version 0.0.0
 * @copyright 2016 Lacatusu Mihai Daniel <lacatusu.mihai.daniel@gmail.com>
