 ...
 * @license MIT
 */
!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var n;n="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this,n.videojsUtils=e()}}(function(){return function e(n,t,i){function r(s,a){if(!t[s]){if(!n[s]){var u="function"==typeof require&&require;if(!a&&u)return u(s,!0);if(o)return o(s,!0);var l=new Error("Cannot find module '"+s+"'");throw l.code="MODULE_NOT_FOUND",l}var c=t[s]={exports:{}};n[s][0].call(c.exports,function(e){var t=n[s][1][e];return r(t?t:e)},c,c.exports,e,n,t,i)}return t[s].exports}for(var o="function"==typeof require&&require,s=0;s<i.length;s++)r(i[s]);return r}({1:[function(e,n,t){(function(e){"use strict";function i(e){return e&&e.__esModule?e:{"default":e}}function r(e,n){var t=u(e,n)?c:l;t(e,n)}!function(e){var n={},t={contentType:"application/x-www-form-urlencoded"},i=function(e){var n;try{n=JSON.parse(e.responseText)}catch(t){n=e.responseText}return[n,e]},r=function(n,r,o){var s={success:function(){},error:function(){},always:function(){}},a=e.XMLHttpRequest||ActiveXObject,u=new a("MSXML2.XMLHTTP.3.0");u.open(n,r,!0),u.setRequestHeader("Content-type",t.contentType),u.onreadystatechange=function(){var e;4===u.readyState&&(e=i(u),u.status>=200&&u.status<300?s.success.apply(s,e):s.error.apply(s,e),s.always.apply(s,e))},u.send(o);var l={success:function(e){return s.success=e,l},error:function(e){return s.error=e,l},always:function(e){return s.always=e,l}};return l};n.get=function(e){return r("GET",e)},n.put=function(e,n){return r("PUT",e,n)},n.post=function(e,n){return r("POST",e,n)},n["delete"]=function(e){return r("DELETE",e)},n.setContentType=function(e){t.contentType=e},e.ajax=n}(window),function(){for(var e=0,n=["ms","moz","webkit","o"],t=0;t<n.length&&!window.requestAnimationFrame;++t)window.requestAnimationFrame=window[n[t]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[n[t]+"CancelAnimationFrame"]||window[n[t]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(n,t){var i=(new Date).getTime(),r=Math.max(0,16-(i-e)),o=window.setTimeout(function(){n(i+r)},r);return e=i+r,o}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(e){clearTimeout(e)})}();var o=function(){function e(e,n){for(var t=0;t<n.length;t++)if(n[t]===e)return!0;return!1}function n(e,n){if(e.map)return e.map(n);var t,i=[];for(t=0;t<e.length;t++)i.push(n(e[t]));return i}function t(e,n){return e.bind?e.bind(n):function(){return e.apply(n,arguments)}}function i(e){var n=[].slice.call(arguments,1);setTimeout(function(){e.apply(this,n)},0)}function r(){var e;for(e in r.prototype)r.prototype.hasOwnProperty(e)&&(this[e]=r.prototype[e]);this._listeners={}}function o(n,t,r){function s(){var e=m.shift(),n=null;return e?("number"==typeof r&&(n=setTimeout(function(){i(t,{e:Error("Load event not fired within "+r+"ms")},d)},r)),void new o[e.type](e.path,function(e,i){return n&&clearTimeout(n),d.dom=i&&i.dom,e&&d.alternates.length?s():void t(e,d)})):void i(t,{e:Error("No viable alternatives")},null)}if(!(this instanceof o))return new o(n,t,r);var a,u,l,c,d=this,m=[];if("string"!=typeof n)return void i(t,TypeError("Invalid path"),d);for(a=n.split("*:"),u=a[a[1]?1:0].split("||"),d.id=a[1]?a[0]:u[0],d.alternates=m,a=0;a<u.length;a++)l=u[a].split("."),l=l[l.length-1].toLowerCase(),c=f[l]?f[l].media:e(l,p.imageTypes)?"image":"document",f[l]&&!f[l].supported||m.push({type:c,path:u[a]});m.length||m.push({type:c,path:u[a-1]}),s()}function s(e){return function(n,t){function i(){o.onload=o.onerror=null,o.removeEventListener&&o.removeEventListener("canplaythrough",i,!0),t(null,r)}var r=this,o=e();o.addEventListener&&o.addEventListener("canplaythrough",i,!0),o.onload=i,o.onerror=function(e){t(e,r)},r.dom=o,o.src=n,o.load&&o.load()}}function a(){var e=this,n=arguments;return e instanceof a?(e.files=[],a.EventEmitter.call(e),e.loadCallback=t(e.loadCallback,e),void(n.length&&e.loadFiles.apply(e,n))):(e=new a,n.length&&e.loadFiles.apply(e,n),e)}var u="undefined"==typeof XMLHttpRequest?function(){try{return new ActiveXObject("Msxml2.XMLHTTP.6.0")}catch(e){}try{return new ActiveXObject("Msxml2.XMLHTTP.3.0")}catch(n){}return null}:XMLHttpRequest,l="undefined"!=typeof Audio?function(){return new Audio}:function(){return document.createElement("audio")},c="undefined"!=typeof Video?function(){return new Video}:function(){return document.createElement("video")},d=function(){return new Image},f={oga:{codec:'audio/ogg; codecs="vorbis"',media:"audio"},wav:{codec:'audio/wav; codecs="1"',media:"audio"},webma:{codec:'audio/webm; codecs="vorbis"',media:"audio"},mp3:{codec:'audio/mpeg; codecs="mp3"',media:"audio"},m4a:{codec:'audio/mp4; codecs="mp4a.40.2"',media:"audio"},ogv:{codec:'video/ogg; codecs="theora, vorbis"',media:"video"},webmv:{codec:'video/webm; codecs="vorbis, vp8"',media:"video"},m4v:{codec:'video/mp4; codecs="avc1.42E01E, mp4a.40.2"',media:"video"}},p={imageTypes:["jpg","png","jpeg","tiff","gif"]},m="FILE@";return f.ogg=f.oga,f.mp4=f.m4v,f.webm=f.webmv,r.prototype={_listeners:null,emit:function(e,n){if(n=n||[],this._listeners[e])for(var t=0;t<this._listeners[e].length;t++)this._listeners[e][t].apply(this,n);return this},on:function(e,n){return this._listeners[e]=this._listeners[e]||[],this._listeners[e].push(n),this},off:function(e,n){if(this._listeners[e]){if(!n)return delete this._listeners[e],this;for(var t=0;t<this._listeners[e].length;t++)this._listeners[e][t]===n&&this._listeners[e].splice(t--,1);this._listeners[e].length||delete this._listeners[e]}return this},once:function(e,n){function t(){return this.off(t),n.apply(this,arguments)}return this.on(e,t)}},o.audio=s(l),o.video=s(c),o.image=s(d),o.document=function(e,n){var t=this,r=/(\[(!)?(.+)?\])?$/.exec(e),o=r[3],s=t.dom=new u;return s?(e=e.substr(0,e.length-r[0].length),e+=r[2]?(-1===e.indexOf("?")?"?":"&")+"fobarz="+ +new Date:"",o&&s.overrideMimeType("@"===o?"text/plain; charset=x-user-defined":o),s.onreadystatechange=function(){if(4===s.readyState)try{t.dom=s.responseXML&&s.responseXML.documentElement?s.responseXML:String(s.responseText||""),200===s.status?n(null,t):n({e:Error("Request failed: "+s.status)},t)}catch(e){n({e:e},t)}},s.onerror=function(e){n(e,t)},s.open("GET",e,!0),void s.send()):void i(n,Error("No XHR!"),t)},function(){var e,n=l(),t=c();p.audio=!!n.canPlayType,p.video=!!t.canPlayType,p.audioTypes=[],p.videoTypes=[];for(e in f)f.hasOwnProperty(e)&&("video"===f[e].media?(f[e].supported=p.video&&t.canPlayType(f[e].codec))&&p.videoTypes.push(e):"audio"===f[e].media&&(f[e].supported=p.audio&&n.canPlayType(f[e].codec))&&p.audioTypes.push(e))}(),p.audio||(o.audio=function(e,n){i(n,Error("<AUDIO> not supported."),e)}),p.video||(o.video=function(e,n){i(n,Error("<VIDEO> not supported."),e)}),a.prototype={active:!1,files:null,filesLoading:0,filesLoaded:0,filesLoadedMap:{},timeout:null,loadCallback:function(e,n){this.filesLoadedMap[n.id]||(this.filesLoaded++,this.filesLoadedMap[n.id]=n),this.emit(e?"error":"fileloaded",e?[e,n]:[n]),this.filesLoading-this.filesLoaded===0&&(this.active=!1,this.emit("finish"),this.filesLoading=0,this.filesLoaded=0)},getFile:function(e){return"undefined"==typeof e?n(this.files,function(e){return e.dom}):"number"==typeof e?this.files[e].dom:"string"==typeof e?this.files[m+e].dom:null},removeFile:function(e){var n,t;switch(typeof e){case"undefined":this.files=[];break;case"number":n=this.files[e],this.files[m+n.id]&&delete this.files[m+n.id],this.files.splice(e,1);break;case"string":for(n=this.files[m+e],n&&delete this.files[m+e],t=0;t<this.files.length;t++)this.files[t]===n&&this.files.splice(t--,1)}},loadFiles:function(){var e,n,t=[].slice.call(arguments);for(e=0;e<t.length;e++)n=a.loadFile(t[e],this.loadCallback,this.timeout),this.files.push(n),this.files[m+n.id]=n,this.filesLoading++;this.active=this.active||!!this.filesLoading},addFiles:function(e){return this.loadFiles.apply(this,e instanceof Array?e:arguments)},getProgress:function(){return this.filesLoading?this.filesLoaded/this.filesLoading:1}},a.support=p,a.loadFile=o,a.EventEmitter=r,a}();!function(){var e="undefined"!=typeof Element&&"ALLOW_KEYBOARD_INPUT"in Element,n=function(){for(var e,n,t=[["requestFullscreen","exitFullscreen","fullscreenElement","fullscreenEnabled","fullscreenchange","fullscreenerror"],["webkitRequestFullscreen","webkitExitFullscreen","webkitFullscreenElement","webkitFullscreenEnabled","webkitfullscreenchange","webkitfullscreenerror"],["webkitRequestFullScreen","webkitCancelFullScreen","webkitCurrentFullScreenElement","webkitCancelFullScreen","webkitfullscreenchange","webkitfullscreenerror"],["mozRequestFullScreen","mozCancelFullScreen","mozFullScreenElement","mozFullScreenEnabled","mozfullscreenchange","mozfullscreenerror"],["msRequestFullscreen","msExitFullscreen","msFullscreenElement","msFullscreenEnabled","MSFullscreenChange","MSFullscreenError"]],i=0,r=t.length,o={};r>i;i++)if(e=t[i],e&&e[1]in document){for(i=0,n=e.length;n>i;i++)o[t[0][i]]=e[i];return o}return!1}(),t={request:function i(t){var i=n.requestFullscreen;t=t||document.documentElement,/5\.1[\.\d]* Safari/.test(navigator.userAgent)?t[i]():t[i](e&&Element.ALLOW_KEYBOARD_INPUT)},exit:function(){document[n.exitFullscreen]()},toggle:function(e){this.isFullscreen?this.exit():this.request(e)},raw:n};return n?(Object.defineProperties(t,{isFullscreen:{get:function(){return Boolean(document[n.fullscreenElement])}},element:{enumerable:!0,get:function(){return document[n.fullscreenElement]}},enabled:{enumerable:!0,get:function(){return Boolean(document[n.fullscreenEnabled])}}}),void(window.screenfull=t)):void(window.screenfull=!1)}(),function(){function n(){try{return s in r&&r[s]}catch(e){return!1}}var t,i={},r="undefined"!=typeof window?window:e,o=r.document,s="localStorage",a="script";if(i.disabled=!1,i.version="1.3.20",i.set=function(e,n){},i.get=function(e,n){},i.has=function(e){return void 0!==i.get(e)},i.remove=function(e){},i.clear=function(){},i.transact=function(e,n,t){null==t&&(t=n,n=null),null==n&&(n={});var r=i.get(e,n);t(r),i.set(e,r)},i.getAll=function(){var e={};return i.forEach(function(n,t){e[n]=t}),e},i.forEach=function(){},i.serialize=function(e){return JSON.stringify(e)},i.deserialize=function(e){if("string"==typeof e)try{return JSON.parse(e)}catch(n){return e||void 0}},n())t=r[s],i.set=function(e,n){return void 0===n?i.remove(e):(t.setItem(e,i.serialize(n)),n)},i.get=function(e,n){var r=i.deserialize(t.getItem(e));return void 0===r?n:r},i.remove=function(e){t.removeItem(e)},i.clear=function(){t.clear()},i.forEach=function(e){for(var n=0;n<t.length;n++){var r=t.key(n);e(r,i.get(r))}};else if(o&&o.documentElement.addBehavior){var u,l;try{l=new ActiveXObject("htmlfile"),l.open(),l.write("<"+a+">document.w=window</"+a+'><iframe src="/favicon.ico"></iframe>'),l.close(),u=l.w.frames[0].document,t=u.createElement("div")}catch(c){t=o.createElement("div"),u=o.body}var d=function(e){return function(){var n=Array.prototype.slice.call(arguments,0);n.unshift(t),u.appendChild(t),t.addBehavior("#default#userData"),t.load(s);var r=e.apply(i,n);return u.removeChild(t),r}},f=new RegExp("[!\"#$%&'()*+,/\\\\:;<=>?@[\\]^`{|}~]","g"),p=function(e){return e.replace(/^d/,"___$&").replace(f,"___")};i.set=d(function(e,n,t){return n=p(n),void 0===t?i.remove(n):(e.setAttribute(n,i.serialize(t)),e.save(s),t)}),i.get=d(function(e,n,t){n=p(n);var r=i.deserialize(e.getAttribute(n));return void 0===r?t:r}),i.remove=d(function(e,n){n=p(n),e.removeAttribute(n),e.save(s)}),i.clear=d(function(e){var n=e.XMLDocument.documentElement.attributes;e.load(s);for(var t=n.length-1;t>=0;t--)e.removeAttribute(n[t].name);e.save(s)}),i.forEach=d(function(e,n){for(var t,r=e.XMLDocument.documentElement.attributes,o=0;t=r[o];++o)n(t.name,i.deserialize(e.getAttribute(t.name)))})}try{var m="__storejs__";i.set(m,m),i.get(m)!=m&&(i.disabled=!0),i.remove(m)}catch(c){i.disabled=!0}i.enabled=!i.disabled,window.store=i}(),Object.defineProperty(t,"__esModule",{value:!0});var s="undefined"!=typeof window?window.videojs:"undefined"!=typeof e?e.videojs:null,a=i(s);parent!==window&&window.frameElement&&(window.frameElement.setAttribute("allowfullscreen","true"),window.frameElement.setAttribute("mozallowfullscreen","true"),window.frameElement.setAttribute("webkitallowfullscreen","true"),window.frameElement.setAttribute("frameborder","0"));var u,l,c,d=function(e){return new RegExp("(^|\\s+)"+e+"(\\s+|$)")};"classList"in document.documentElement?(u=function(e,n){return e.classList.contains(n)},l=function(e,n){n=n.split(" ");for(var t in n)e.classList.add(n[t])},c=function(e,n){e.classList.remove(n)}):(u=function(e,n){return d(n).test(e.className)},l=function(e,n){u(e,n)||(e.className=e.className+" "+n)},c=function(e,n){e.className=e.className.replace(d(n)," ")});var f={preloader:o(),getRandBinary:function(){return Math.floor(2*Math.random())},device:{browser:function(){var e,n,t,i=(navigator.appVersion,navigator.userAgent),r=navigator.appName,o=""+parseFloat(navigator.appVersion),s=parseInt(navigator.appVersion,10);if("Netscape"==r&&navigator.appVersion.indexOf("Trident")>-1){r="IE";var a=i.indexOf("Edge/");o=i.substring(a+5,i.indexOf(".",a))}else-1!==navigator.appVersion.indexOf("Windows NT")&&-1!==navigator.appVersion.indexOf("rv:11")?(r="IE",o="11;"):-1!==(n=i.indexOf("MSIE"))?(r="IE",o=i.substring(n+5)):-1!==(n=i.indexOf("Chrome"))?(r="Chrome",o=i.substring(n+7)):-1!==(n=i.indexOf("Safari"))?(r="Safari",o=i.substring(n+7),-1!==(n=i.indexOf("Version"))&&(o=i.substring(n+8))):-1!==(n=i.indexOf("Firefox"))?(r="Firefox",o=i.substring(n+8)):(e=i.lastIndexOf(" ")+1)<(n=i.lastIndexOf("/"))&&(r=i.substring(e,n),o=i.substring(n+1),r.toLowerCase()==r.toUpperCase()&&(r=navigator.appName));return-1!==(t=o.indexOf(";"))&&(o=o.substring(0,t)),-1!==(t=o.indexOf(" "))&&(o=o.substring(0,t)),s=parseInt(""+o,10),isNaN(s)&&(o=""+parseFloat(navigator.appVersion),s=parseInt(navigator.appVersion,10)),[r,s]}(),ie:function(){return"IE"===this.browser[0]?this.browser[1]:!1},ios:function(){for(var e=["iPad Simulator","iPhone Simulator","iPod Simulator","iPad","iPhone","iPod"];e.length;)if(navigator.platform===e.pop())return!0;return!1}},url:{params:function(){for(var e={},n=window.location.search.substring(1),t=n.split("&"),i=0;i<t.length;i++){var r=t[i].split("=");if(r.length>1)if("undefined"==typeof e[r[0]])e[r[0]]=decodeURIComponent(r[1]);else if("string"==typeof e[r[0]]){var o=[e[r[0]],decodeURIComponent(r[1])];e[r[0]]=o}else e[r[0]].push(decodeURIComponent(r[1]))}return e}()},hasClass:u,addClass:l,removeClass:c,toggleClass:r};a["default"].plugin("ajax",ajax),a["default"].plugin("utils",f),f.VERSION="0.0.0",t["default"]=f,n.exports=t["default"]}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}]},{},[1])(1)});
/**
 * videojs-bounds
 * @version 0.0.1
 * @copyright 2016 Lacatusu Mihai Daniel <lacatusu.mihai.daniel@gmail.com>
...
/*! videojs-responsive - v0.1.0 - 2016-06-10
* Copyright (c) 2016 Lacatusu Mihai Daniel; Licensed Apache-2.0 */
!function(a,b){"use strict";var c,d={x:null,y:null,width:null,height:null,offsetX:0,offsetY:0,active:!0,onVisible:!1,transform:{x:void 0,y:void 0},scale:{x:!0,y:!0,width:!0,height:!0},font:{min:!1,ratio:!1,lineHeight:void 0,units:"em"},callback:null};c=function(c,e){function f(a){i=b.mergeOptions(d,a),j=i.scale,k=i.font,void 0===i.translate&&(i.translate=!0),i.player&&(l=i.player),"center"==i.x&&(i.x=0,i.width="full")}function g(a){var b="Webkit Moz ms O".split(" "),c=document.documentElement.style;if(void 0!==c[a])return a;a=a.charAt(0).toUpperCase()+a.substr(1);for(var d=0;d<b.length;d++)if(void 0!==c[b[d]+a])return b[d]+a}function h(a,b){var c=0;if(b.min!==!1&&b.ratio!==!1){var c=b.ratio*l.bounds().width/1e3;if(c<b.min&&(c=b.min),"px"==b.units&&(c=Math.ceil(c)),a.style.fontSize=c+b.units,!isNaN(b.lineHeight)){var d=c*b.lineHeight;1>d&&(d=1),a.style.lineHeight=d+b.units}"auto"==b.lineHeight&&(a.style.lineHeight=a._height+"px")}return c}c.nodeName||(c=document.querySelector(c));var i={},j=!1,k=!1,l=this;f(e),c._height=i.height,c._width=i.width;var m={transform:g("transform"),perspective:g("perspective"),backfaceVisibility:g("backfaceVisibility")},n=function(a){return i.onVisible?a.offsetWidth>0||a.offsetHeight>0:!0},o=function(){if(n(c)){var a,b,d=l.bounds(),e=null,f=null,g=d.width/d.width_org;if("function"==typeof i.callback&&i.callback(d),null!=i.width&&(a="full"==i.width||"100%"==i.width?d.width:i.width*(j.width?g:1),c.style.width=a+"px"),null!=i.height&&(b="full"==i.height||"100%"==i.height?d.height:i.height*(j.height?g:1),c.style.height=b+"px"),c._height=b,c._width=a,h(c,k),null!=i.x&&(e=d.offset_x+i.x*(j.x?g:1)),"bottom"==i.y?f=d.offset_y+d.height:"top"==i.y?f=d.offset_y:null!=i.y&&(f=d.offset_y+i.y*(j.y?g:1)),"-100%"===i.transform.y&&(f-=b),i.offsetY&&(f+=i.offsetY),i.offsetX&&(e+=i.offsetX),m.transform&&i.translate){var o="";return null!=e&&null!=f?(o="translate("+e+"px,"+f+"px)",c.style.left="auto",c.style.right="auto",c.style.bottom="auto",c.style.top="auto"):(null!=e&&(c.style.left="auto",c.style.right="auto",o="translateX("+e+"px)"),null!=f&&(c.style.bottom="auto",c.style.top="auto",o="translateY("+f+"px)")),void(c.style[m.transform]=o)}null!=e&&null!=f?(c.style.left=e+"px",c.style.top=f+"px"):(null!=e&&(c.style.left=e+"px"),null!=f&&(c.style.top=f+"px"))}};c.responsive={update:function(a){f(a),o()},resize:o,disable:function(){a.removeEventListener("resize",o,!1)},enable:function(){o(),a.addEventListener("resize",o,!1)}},i.active&&c.responsive.enable()},b.plugin("responsive",c)}(window,window.videojs);
/*! videojs-cuepoints - v0.0.0 - 2016-06-10
* Copyright (c) 2016 Lacatusu Mihai Daniel; Licensed Apache-2.0 */
!function(a,b){"use strict";function c(a,c,d){var e=b.mergeOptions(i,c);this._player=a,this.parentWrapper=d,this.once=e.once,this.onceStart=!1,this.onceEnd=!1,this.start=e.start,this.end=e.end,this.startFn=e.onStart,this.endFn=e.onEnd,this.clickFn=e.onClick,this.params=e.params,this.fired=!1,this.active=e.active,this.inactive=e.inactive,this.label=e.label,this.className=e.className,this._vc=!1,this._width=e.width,this.addVisual(e.visual),this.activate()}var d,e,f,g,h={wrapper:!1},i={once:!1,start:0,end:-1,onStart:function(){},onEnd:function(){},onClick:function(){},params:{},active:"active",inactive:"inactive",className:"vjs-cuepoint",label:!1,visual:!1,width:null},j=function(a){return new RegExp("(^|\\s+)"+a+"(\\s+|$)")};"classList"in document.documentElement?(e=function(a,b){return a.classList.contains(b)},f=function(a,b){b=b.split(" ");for(var c in b)a.classList.add(b[c])},g=function(a,b){a.classList.remove(b)}):(e=function(a,b){return j(b).test(a.className)},f=function(a,b){e(a,b)||(a.className=a.className+" "+b)},g=function(a,b){a.className=a.className.replace(j(b)," ")}),c.prototype.addVisual=function(a){var b=this;if(!this._vc&&a){if(a instanceof HTMLElement)this._vc=a;else{if(!a)return;this._vc=document.createElement("div")}"string"==typeof this.label&&(this._label=document.createElement("span"),this._label.innerHTML=this.label,this._vc.appendChild(this._label)),f(this._vc,this.className),this.start>0&&f(this._vc,this.inactive),this._vc.style.left=this.start/this._player.duration()*100+"%",this._width&&this.end>1&&(this._vc.style.right=100-this.end/this._player.duration()*100+"%"),this._vc.addEventListener("click",function(){b.clickFn.call(b,b.params)}),this.parentWrapper&&this.parentWrapper.appendChild(this._vc)}},c.prototype.activateVisual=function(a){this._vc&&(a&&this.activate(),this._vc.style.display="block")},c.prototype.disableVisual=function(a){this._vc&&(a&&this.suspend(),this._vc.style.display="none")},c.prototype._process=function(){var a=this._player.currentTime();if(a>=this.start&&(this.end<0||a<this.end)){if(this.fired)return;this.onceStart||(this._start(),this._vc&&(e(this._vc,this.active)||(g(this._vc,this.inactive),f(this._vc,this.active))),this.once&&(this.onceStart=!0)),this.fired=!0}else{if(this.onceEnd||this._vc&&(e(this._vc,this.inactive)||(g(this._vc,this.active),f(this._vc,this.inactive))),!this.fired)return;this.onceEnd||(this._end(),this.once&&(this.onceEnd=!0)),this.fired=!1}},c.prototype.start=0,c.prototype.end=-1,c.prototype._start=function(){this.startFn.call(this,this.params)},c.prototype._end=function(){this.endFn.call(this,this.params)},c.prototype.activate=function(){var a=this;void 0===this.processHandler&&(this.processHandler=function(){a._process()}),this._player.on("timeupdate",this.processHandler)},c.prototype.suspend=function(){this._player.off("timeupdate",this.processHandler)},c.prototype.destroy=function(){this._player.off("timeupdate",this.processHandler)},d=function(a){var d=b.mergeOptions(h,a),e=this,f=[],g=null,i={};i.add=function(a){var b=new c(e,a,g);return f.push(b),b},i.show=function(){for(var a=f.length-1;a>=0;a--)f[a]._vc&&(f[a]._vc.style.display="block")},i.hide=function(){for(var a=f.length-1;a>=0;a--)f[a]._vc&&(f[a]._vc.style.display="none")},i.suspend=function(a){for(var a=f.length-1;a>=0;a--)f[a].suspend()},i.resume=function(a){for(var a=f.length-1;a>=0;a--)f[a].activate()},i.destroy=function(){for(var a=0,b=f.length;b>a;a++)f[a]._vc&&g&&g.removeChild(f[a]._vc),f[a].destroy(),f[a]=null;f=[]},i.wrapper=function(a){var b=f.length;if(g)for(var c=0;b>c;c++)f[c]._vc&&g&&g.removeChild(f[c]._vc),f[c].destroy();if("string"==typeof a&&(g=document.querySelector(a)),a instanceof HTMLElement&&(g=a),g)for(var c=0;b>c;c++)f[c]._vc&&g&&g.appendChild(f[c]._vc),f[c].activate()},i.init=function(){g?this.destroy():d.wrapper?g=document.querySelector(d.wrapper):e.controlBar&&e.controlBar.el_&&(g=e.controlBar.el_.querySelector(".vjs-progress-control"))},void 0===this.cuepoints.add&&(i.init(),this.cuepoints=i)},b.plugin("cuepoints",d)}(window,window.videojs);
/*! videojs-overlays - v0.1.0 - 2016-06-10
* Copyright (c) 2016 Lacatusu Mihai Daniel; Licensed Apache-2.0 */
!function(a,b){"use strict";var c={},d={x:0,y:0,width:0,height:0,origin:"topLeft",start:0,end:-1,className:null,onShow:null,onHide:null,onMouseEnter:null,onMouseMove:null,onMouseLeave:null,onClick:null,content:null,font:{min:1,ratio:1,lineHeight:"auto",units:"em"},path:!1,visible:void 0},e={},f={},g=function(a){return new RegExp("(^|\\s+)"+a+"(\\s+|$)")},h=function(a){var b="Webkit Moz ms O".split(" "),c=document.documentElement.style;if(void 0!==c[a])return a;a=a.charAt(0).toUpperCase()+a.substr(1);for(var d=0;d<b.length;d++)if(void 0!==c[b[d]+a])return b[d]+a},i=function(a,b){return"translate("+a+"px,"+b+"px)"},j={transform:h("transform"),perspective:h("perspective"),backfaceVisibility:h("backfaceVisibility")},k=function(a,b,c,d,e){var f={x:a,y:b};switch(e){case"center":f.x=a-c/2,f.y=b-d/2;break;case"top":f.x=a-c/2;break;case"left":f.y=b-d/2;break;case"right":f.x=a-c,f.y=b-d/2;break;case"topRight":f.x=a-c;break;case"bottom":f.x=a-c/2,f.y=b-d;break;case"bottomLeft":f.y=b-d;break;case"bottomRight":f.x=a-c,f.y=b-d}return f},l=function(a,c){function h(){var a=f[c.id_].n+"_"+f[c.id_].i;return f[c.id_].i+=1,a}var l=b.mergeOptions(d,a),m=function(a,b){return function(){return a.apply(b,arguments)}};if(void 0!==l.id){this.id=l.id;for(var n in e[c.id_])if(e[c.id_][n].id==l.id){this.id=h();break}}else this.id=h();if(this.x=l.x,this.y=l.y,this.width=l.width,this._width=l.width,this.height=l.height,this._height=l.height,this.start=l.start,this.end=l.end,this.path=l.path,this.origin=l.origin,this._pathStart=void 0,this._pathEnd=void 0,this._refreshStart=0,this._refreshEnd=0,("100%"===l.width||"full"===l.width)&&(this.width=c.videoWidth()),("100%"===l.height||"full"===l.height)&&(this.height=c.videoHeight()),"[object Array]"===Object.prototype.toString.call(this.path)?(this.path[0].start&&(this._pathStart=this.path[0].start),this.path[this.path.length-1].end&&(this._pathEnd=this.path[this.path.length-1].end)):this.path=!1,this.checkRefresh=function(a){void 0!==this._pathStart&&void 0!==this._pathEnd&&(a>=this._pathStart&&a<=this._pathEnd?(0!==this._refreshStart&&(this._refreshStart=0),0!==this._refreshEnd&&(this._refreshEnd=0)):(a<this._pathStart&&1!==this._refreshStart&&(this.resize(),this._refreshStart=1),a>this._pathEnd&&1!==this._refreshEnd&&(this.resize(),this._refreshEnd=1)))},l.className===Array?l.className="vjs-overlay "+l.className.join(" "):void 0!=l.className?l.className="vjs-overlay "+l.className:l.className="vjs-overlay","classList"in document.documentElement?(this.hasClass=function(a){return this.el_.classList.contains(a)},this.addClass=function(a){a=a.split(" ");for(var b in a)this.el_.classList.add(a[b])},this.removeClass=function(a){this.el_.classList.remove(a)}):(this.hasClass=function(a){return g(a).test(this.el_.className)},this.addClass=function(a){this.hasClass(a)||(this.el_.className=this.el_.className+" "+a)},this.removeClass=function(a){this.el_.className=this.el_.className.replace(g(a)," ")}),this.toggleClass=function(a){this.hasClass(a)?this.removeClass(a):this.addClass(a)},this.el=function(){this.el_||(this.el_=document.createElement("div"),this.el_.className=l.className,this.el_.style.position="absolute",this.el_.style.top=this.y||0,this.el_.style.left=this.x||0,this.el_.style.width=(this.width||0)+"px",this.el_.style.height=(this.height||0)+"px","function"==typeof l.onClick&&this.el_.addEventListener("click",m(l.onClick,this)));var a=this;return"function"==typeof l.onMouseEnter&&this.el_.addEventListener("mouseenter",function(b){m(l.onMouseEnter,a)(b)}),"function"==typeof l.onMouseLeave&&this.el_.addEventListener("mouseleave",function(b){m(l.onMouseLeave,a)(b)}),"function"==typeof l.onMouseMove&&this.el_.addEventListener("mousemove",function(b){m(l.onMouseMove,a)(b)}),this.el_},this.el(),this.content=l.content,this.content){if("function"==typeof this.content){m(this.content,this);this.content=this.content(),this.el_.appendChild(this.content)}if(this.content.nodeName&&this.el_.appendChild(this.content),"string"==typeof this.content&&(this.el_.innerHTML=this.content),"[object Array]"===Object.prototype.toString.call(this.content))for(var n in this.content)this.content[n].nodeName&&this.el_.appendChild(this.content[n])}this.font=function(a){if(l.font=a||l.font,l.font&&this.visible&&c){var b=c.bounds();l.font.ratio=l.font.ratio||1,l.font.min=l.font.min||1;var d=l.font.ratio*b.width/1e3;if(d<l.font.min&&(d=l.font.min),this.el_.style.fontSize=d+l.font.units,null==l.font.lineHeight||void 0==l.font.lineHeight||"auto"==l.font.lineHeight)this.el_.style.lineHeight=this._height+"px";else if(l.font.lineHeight!==!1&&!isNaN(l.font.lineHeight)){var e=d*l.font.lineHeight;1>e&&(e=1),this.el_.style.lineHeight=e+l.font.units}}},this.resize=function(a,b){if(this.visible){var d=c.bounds();void 0===a&&(a={x:this.x,y:this.y}),void 0===b&&(b={width:this.width,height:this.height});var e=b.width*d.width/d.width_org,f=b.height*d.height/d.height_org,g=d.offset_x+a.x*d.width/d.width_org,h=d.offset_y+a.y*d.height/d.height_org,l=k(g,h,e,f,this.origin),m="";if(g=l.x,h=l.y,this.el_.style.width=e+"px",this.el_.style.height=f+"px",this._width=e,this._height=f,j.transform)return m+=i(g,h),void(this.el_.style[j.transform]=m);this.el_.style.left=g+"px",this.el_.style.top=h+"px"}},this.originPoint=function(a){return void 0!=a&&(this.origin=a,this.resize()),this.origin};var o=!1;this.hide=function(){o=!0,this._hide()},this._hide=function(){this.visible&&(this.visible=!1,this.trigger("hide"),this.el_.style.display="none")},this.show=function(){o=!1,this.visible=!0,this.resize(),this.font(),this.el_.style.display="block",this.trigger("show")},this._show=function(){this.visible||o||(this.visible=!0,this.resize(),this.font(),this.el_.style.display="block",this.trigger("show"))},this.trigger=function(a){switch(a){case"show":"function"==typeof l.onShow&&m(l.onShow,this)();break;case"hide":"function"==typeof l.onHide&&m(l.onHide,this)();break;case"click":"function"==typeof l.onClick&&m(l.onClick,this)();break;default:return}},this.destroy=function(){this.el_.parentNode.removeChild(this.el_);for(var a in e[c.id_])if(e[c.id_][a].id==this.id){delete e[c.id_][a],f[c.id_].i-=1;break}},l.start>0?(this.visible=!1,this.el_.style.display="none"):(this.visible=!0,this.el_.style.display="block"),void 0!==l.visible&&(this.visible=l.visible),this.resize(),this.font()},m=function(d){function g(a){var b=new l(a,k);return m.appendChild(b.el_),e[k.id_][b.id]=b,b}function h(){if(n.visible)for(var a in e[k.id_]){var b=e[k.id_][a];if(b.path){var c=k.currentTime();(c<b._pathStart||c>b._pathEnd)&&b.resize()}else b.resize();b.font()}}function i(){if(n.visible)for(var a in e[k.id_]){var b=e[k.id_][a],c=k.currentTime();if(c>=b.start&&(c<=b.end||-1===b.end))if(b.path){if(b._show(),b.visible)for(var a=0;a<b.path.length;a+=1){var d=b.path[a],f=parseFloat(d.start),g=parseFloat(d.end),h=parseFloat(d.x),l=parseFloat(d.y);c>=f&&g>=c?h&&l&&b.resize({x:h,y:l},void 0):b.checkRefresh(c)}}else b._show();else b._hide()}var m=function(){i()};j=requestAnimationFrame(m)}var j,k=this,m=null;e[k.id_]={},f[k.id_]={n:"ov",i:0};var n=(b.mergeOptions(c,d),{});return n.add=function(a){var b=null;if(a.constructor===Object&&(b=g(a)),a.constructor===Array){b=[];for(var c in a)b.push(g(a[c]))}return this.resumePaths(),b},n.visible=!1,n.show=function(){if(!this.visible){this.visible=!0;for(var a in e[k.id_])e[k.id_][a].visible||e[k.id_][a].trigger("show");m.style.display="block",h()}},n.hide=function(){if(this.visible){this.visible=!1;for(var a in e[k.id_])e[k.id_][a].visible&&e[k.id_][a].trigger("hide");m.style.display="none"}},n.destroy=function(b){if(b){if("string"==typeof b&&e[k.id_][b]&&e[k.id_][b].destroy(),"object"==typeof b)for(var c in b)e[k.id_][b[c]]&&e[k.id_][b[c]].destroy()}else{for(;m.firstChild;)m.removeChild(m.firstChild);a.removeEventListener("resize",h),cancelAnimationFrame(j),e[k.id_]={},f[k.id_]={n:"ov",i:0}}},n.resumePaths=function(){this.suspendPaths(),i()},n.suspendPaths=function(){cancelAnimationFrame(j)},n.el=function(){return m},n.init=function(){m?n.destroy():k.tech_&&k.tech_.el_&&(m=document.createElement("div"),m.className="vjs-overlays",k.el_.insertBefore(m,k.tech_.el_.nextSibling)),this.show(),a.addEventListener("resize",h)},n.instances=function(a){return void 0===a?e[k.id_]:e[k.id_][a]},void 0===this.overlays.add&&(n.init(),this.overlays=n),n};b.plugin("overlays",m)}(window,window.videojs);
/**
 * videojs-subtitles
 * @version 0.0.0
 * @copyright 2016 Lacatusu Mihai Daniel <lacatusu.mihai.daniel@gmail.com>
 * @license MIT
 */
!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var n;n="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this,n.videojsSubtitles=e()}}(function(){return function e(n,t,i){function o(r,s){if(!t[r]){if(!n[r]){var a="function"==typeof require&&require;if(!s&&a)return a(r,!0);if(l)return l(r,!0);var u=new Error("Cannot find module '"+r+"'");throw u.code="MODULE_NOT_FOUND",u}var d=t[r]={exports:{}};n[r][0].call(d.exports,function(e){var t=n[r][1][e];return o(t?t:e)},d,d.exports,e,n,t,i)}return t[r].exports}for(var l="function"==typeof require&&require,r=0;r<i.length;r++)o(i[r]);return o}({1:[function(e,n,t){(function(e){"use strict";function i(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(t,"__esModule",{value:!0});var o="undefined"!=typeof window?window.videojs:"undefined"!=typeof e?e.videojs:null,l=i(o),r={font:{min:1,ratio:2},offset:0,autoHide:!0,className:"shadow"},s=function(e){return e.replace(/^\s+|\s+$/gm,"")},a=function(e){var n=0;if(e)for(var t=e.split(":"),i=0;i<t.length;i++)n=60*n+parseFloat(t[i].replace(",","."));return n},u=function(e){if(!e)return[];for(var n=e.split(/\r|\n|\r\n/),t=[],i={},o=0,l=n.length;l>o;o++){var r=n[o];if(void 0!==i.start||void 0!==i.end){var u=s(r);""===u?(i.text&&(i.text=i.text.join("<br/>"),t.push(i)),i={}):(i.text||(i.text=[]),i.text.push(u))}else{var d=r.split("-->");d.length>1&&(i.start=a(d[0]),i.end=a(d[1]))}}return t},d=function(e){function n(){d.responsive&&d.responsive.disable(),e.off(e.player_,"timeupdate",m),e.off(e.player_,"ended",g),e.off(e.player_,"play",v),o.autoHide&&e.off(e.player_,"userinactive",h),o.autoHide&&e.off(e.player_,"useractive",b),c.innerHTML="",d.style.display="none"}function t(){s.length>0?(e.paused()&&p(e.currentTime()),e.on("timeupdate",m),e.on("ended",g),e.on(e.player_,"play",v),o.autoHide&&e.on(e.player_,"userinactive",h),o.autoHide&&e.on(e.player_,"useractive",b),d.style.display="block",_()):n()}var e,i=null,o=null,s=[],a=!0,d=null,f=null,c=null,p=function(e){for(var n=0;n<s.length;n+=1){var t=s[n].start,o=s[n].end;e>=t&&o>=e?i!=n&&(i=n,d.disabled&&(d.responsive.enable(),d.disabled=!1),c.style.display="inline-block",c.innerHTML="<span>"+s[n].text+"</span>",a=!1):i==n&&(a||(d.disabled||(d.responsive.disable(),d.disabled=!0),c.innerHTML="",c.style.display="none",a=!0,i=null))}},v=function(){if(e.controlBar)if(y){var n=e.controlBar.el_.getBoundingClientRect();c.style.bottom=n.height+"px"}else c.style.bottom=0},y=!0,h=function(){e.paused()||(y=!1,v())},b=function(){y=!0,v()},m=function(){p(e.currentTime())},g=function(){c.innerHTML="",c.style.display="none"},w=function(){i=null,a=!0,s=[];for(var n=e.tech_.el_.querySelectorAll("track"),t=0;t<n.length;t+=1)e.tech_.el_.removeChild(n[t]);null===d&&(d=document.createElement("div"),d.className="vjs-subtitles-wrapper",f=document.createElement("div"),f.className="vjs-subtitles-holder",c=document.createElement("div"),c.className="vjs-subtitle-text "+o.className,f.appendChild(c),d.appendChild(f),d.style.display="none",e.el_.appendChild(d)),v()},_=function(){d.responsive?d.responsive.enable():e.responsive(d,{x:0,y:0,height:e.videoHeight()-o.offset,width:"100%",callback:function(){v()},font:o.font})};return function(i,a){o=l["default"].mergeOptions(r,a),void 0===e.controlBar&&(o.autoHide=!1),w(),i?i instanceof Array?(s=i,t()):(e.addClass("vjs-waiting"),e.ajax.get(i).success(function(n,i){s=u(n),t(),e.removeClass("vjs-waiting")}).error(function(t,i){n(),e.removeClass("vjs-waiting")})):n()}},f=function(){void 0===this.subtitles.add&&(this.subtitles=new d(this))};l["default"].plugin("subtitles",f),f.VERSION="0.0.0",t["default"]=f,n.exports=t["default"]}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{}]},{},[1])(1)});
/**
 * videojs-visibility
 * @version 0.0.0
 * @copyright 2016 Lacatusu Mihai Daniel <lacatusu.mihai.daniel@gmail.com>
...
window.VIDEOJS_NO_DYNAMIC_STYLE=!0;var kmlplayer=function(e,t,i,n){function o(e,t){for(var i in t)try{t[i].constructor==Object?e[i]=o(e[i],t[i]):e[i]=t[i]}catch(n){e[i]=t[i]}return e}videojs.options.flash.swf=n||"kmlPlayer/kmlPlayer.swf";var i=i||{},s={techOrder:["html5","flash"],muted:!1,controls:!0,posterImage:!1,autoplay:!1,loop:!1,preload:"auto",errorDisplay:!0,textTrackDisplay:!1,textTrackSettings:!1,controlBar:{playToggle:!0,audioTrackButton:!1,muteToggle:!1,volumeMenuButton:{vertical:!0,inline:!1},chaptersButton:!1,subtitlesButton:!1,captionsButton:!1,playbackRateMenuButton:!1,customControlSpacer:!1,fullscreenToggle:!!screenfull.enabled,currentTimeDisplay:!1,timeDivider:!1,durationDisplay:!1,liveDisplay:!1,remainingTimeDisplay:!1,descriptionsButton:!1,progressControl:{seekBar:{loadProgressBar:!0,mouseTimeDisplay:!1}}},timeline:{x:0,responsive:"scaled",offsetY:-30,width:"full",height:44,font:!1,transform:{x:void 0,y:void 0}},visibility:{onHidden:function(){},onVisible:function(){}}},t=o(s,t||{});if(t.controlBar){var r=t.controlBar.elementsOrder;if(r){var l={};for(var a in r)t.controlBar[r[a]]&&(l[r[a]]=t.controlBar[r[a]]);t.controlBar={children:l},delete t.controlBar.elementsOrder}}return new videojs(e,t,function(){this.on("ready",function(){if(!this.__readyPlugins){this.contextmenu&&this.contextmenu("custom");var e=this;this.keyboard={enabled:!0,enable:function(e){return void 0===e?this.enabled:void(e?this.enabled=!0:this.enabled=!1)},_seek:!0,seek:function(e){return void 0===e?this._seek:void(e?this._seek=!0:this._seek=!1)},keydown:function(t){e.keyboard.enabled&&(32==t.keyCode&&(e.paused()?e.play():e.pause()),e.keyboard._seek&&(37==t.keyCode&&e.currentTime(e.currentTime()-5),39==t.keyCode&&e.currentTime(e.currentTime()+5)),38==t.keyCode&&e.volume(e.volume()+.1),40==t.keyCode&&e.volume(e.volume()-.1),e.controlBar&&e.controlBar.volumeMenuButton&&(40!=t.keyCode&&38!=t.keyCode||(e.controlBar.volumeMenuButton.menuContent.el_.className="vjs-menu show")))},tId:null,keyup:function(t){e.keyboard.enabled&&e.controlBar&&(40!=t.keyCode&&38!=t.keyCode||(clearInterval(e.keyboard.tId),e.controlBar.volumeMenuButton&&(e.keyboard.tId=setTimeout(function(){e.controlBar.volumeMenuButton.menuContent.el_.className="vjs-menu"},500))))},init:function(){this.enabled=!0,this.tId=null,document.body.addEventListener("keydown",this.keydown,!1),document.body.addEventListener("keyup",this.keyup,!1)},destroy:function(){this.enabled=!1,this.tId=null,document.body.removeEventListener("keydown",this.keydown),document.body.removeEventListener("keyup",this.keyup)}},this.keyboard.init(),this.__readyPlugins=!0}"function"==typeof i.ready&&i.ready.call(this)}),this.on("timeupdate",function(){"function"==typeof i.timeupdate&&i.timeupdate.call(this,this.currentTime())}),this.on("durationchange",function(){"function"==typeof i.durationchange&&i.durationchange.call(this,this.duration())}),this.on("error",function(){"function"==typeof i.error&&i.error.call(this,this.error())}),this.on("volumechange",function(){"function"==typeof i.volumechange&&i.volumechange.call(this,this.volume())}),this.on("seeked",function(){"function"==typeof i.seeked&&i.seeked.call(this,this.currentTime())}),this.on("seeking",function(){"function"==typeof i.seeking&&i.seeking.call(this,this.currentTime())}),this.on("ratechange",function(){"function"==typeof i.ratechange&&i.ratechange.call(this,this.playbackRate())}),this.on("loadedmetadata",function(){this.__loadedPlugins||(this.cuepoints&&this.cuepoints(),this.overlays&&this.overlays(),this.subtitles&&this.subtitles(),this.scorm&&this.scorm(),t.visibility&&this.visibility&&this.visibility({onHidden:t.visibility.onHidden,onVisible:t.visibility.onVisible}),this.__loadedPlugins=!0),t.controlBar&&t.timeline&&("scaled"===t.timeline.responsive?this.controlBar.el_.responsive?this.controlBar.el_.responsive.update({x:t.timeline.x,y:t.timeline.y||this.videoHeight()-44,width:t.timeline.width,height:t.timeline.height,transform:t.transform,font:{min:.5,ratio:2}}):(this.addClass("vjs-scaleControlbar"),this.responsive(this.controlBar.el_,{x:t.timeline.x,y:t.timeline.y||this.videoHeight()-44,width:t.timeline.width,height:t.timeline.height,transform:t.transform,font:{min:.5,ratio:2}})):t.timeline.responsive&&(this.controlBar.el_.responsive?this.controlBar.el_.responsive.update({x:t.timeline.x,y:t.timeline.y||this.videoHeight(),width:t.timeline.width,offsetY:t.timeline.offsetY,transform:t.transform,font:t.timeline.font}):this.responsive(this.controlBar.el_,{x:t.timeline.x,y:t.timeline.y||this.videoHeight(),width:t.timeline.width,offsetY:t.timeline.offsetY,transform:t.transform,font:t.timeline.font}))),"function"==typeof i.loadedmetadata&&i.loadedmetadata.call(this)});for(var e in i)"loadedmetadata"!=e&&"ready"!=e&&"timeupdate"!=e&&"volumechange"!=e&&"seeked"!=e&&"seeking"!=e&&"ratechange"!=e&&"durationchange"!=e&&"error"!=e&&this.on(e,i[e])})};