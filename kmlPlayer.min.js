...
window.VIDEOJS_NO_DYNAMIC_STYLE=!0;var kmlplayer=function(t,i,e,n){function o(t,i){for(var e in i)try{i[e].constructor==Object?t[e]=o(t[e],i[e]):t[e]=i[e]}catch(n){t[e]=i[e]}return t}videojs.options.flash.swf=n||"kmlPlayer/kmlPlayer.swf";var e=e||{},s={techOrder:["html5","flash"],muted:!1,controls:!0,posterImage:!1,autoplay:!1,loop:!1,preload:"auto",errorDisplay:!0,textTrackDisplay:!1,textTrackSettings:!1,controlBar:{audioTrackButton:!1,volumeMenuButton:{vertical:!0,inline:!1},chaptersButton:!1,subtitlesButton:!1,captionsButton:!1,playbackRateMenuButton:!1,customControlSpacer:!1,fullscreenToggle:!!screenfull.enabled,currentTimeDisplay:!1,timeDivider:!1,durationDisplay:!1,liveDisplay:!1,remainingTimeDisplay:!1,descriptionsButton:!1,progressControl:{seekBar:{loadProgressBar:!0,mouseTimeDisplay:!1}}},timeline:{responsive:"scaled",offsetY:-30,width:"full",height:44,font:!1},visibility:{onHidden:function(){},onVisible:function(){}}},i=o(s,i||{});return new videojs(t,i,function(){this.on("ready",function(){this.__readyPlugins||(this.contextmenu&&this.contextmenu("custom"),this.__readyPlugins=!0),"function"==typeof e.ready&&e.ready.call(this)}),this.on("timeupdate",function(){"function"==typeof e.timeupdate&&e.timeupdate.call(this,this.currentTime())}),this.on("durationchange",function(){"function"==typeof e.durationchange&&e.durationchange.call(this,this.duration())}),this.on("error",function(){"function"==typeof e.error&&e.error.call(this,this.error())}),this.on("volumechange",function(){"function"==typeof e.volumechange&&e.volumechange.call(this,this.volume())}),this.on("seeked",function(){"function"==typeof e.seeked&&e.seeked.call(this,this.currentTime())}),this.on("seeking",function(){"function"==typeof e.seeking&&e.seeking.call(this,this.currentTime())}),this.on("ratechange",function(){"function"==typeof e.ratechange&&e.ratechange.call(this,this.playbackRate())}),this.on("loadedmetadata",function(){this.__loadedPlugins||(this.cuepoints&&this.cuepoints(),this.overlays&&this.overlays(),this.subtitles&&this.subtitles(),this.scorm&&this.scorm(),i.visibility&&this.visibility&&this.visibility({onHidden:i.visibility.onHidden,onVisible:i.visibility.onVisible}),this.__loadedPlugins=!0),i.controlBar&&i.timeline&&("scaled"===i.timeline.responsive?this.controlBar.el_.responsive?this.controlBar.el_.responsive.update({x:0,y:this.videoHeight()-44,width:i.timeline.width,height:i.timeline.height,font:{min:.5,ratio:2}}):(this.addClass("vjs-scaleControlbar"),this.responsive(this.controlBar.el_,{x:0,y:this.videoHeight()-44,width:i.timeline.width,height:i.timeline.height,font:{min:.5,ratio:2}})):i.timeline.responsive&&(this.controlBar.el_.responsive?this.controlBar.el_.responsive.update({x:0,y:i.timeline.y||this.videoHeight(),width:i.timeline.width,offsetY:i.timeline.offsetY,font:i.timeline.font}):this.responsive(this.controlBar.el_,{x:0,y:i.timeline.y||this.videoHeight(),width:i.timeline.width,offsetY:i.timeline.offsetY,font:i.timeline.font}))),"function"==typeof e.loadedmetadata&&e.loadedmetadata.call(this)});for(var t in e)"loadedmetadata"!=t&&"ready"!=t&&"timeupdate"!=t&&"volumechange"!=t&&"seeked"!=t&&"seeking"!=t&&"ratechange"!=t&&"durationchange"!=t&&"error"!=t&&this.on(t,e[t])})};