...
<<<<<<< HEAD
window.VIDEOJS_NO_DYNAMIC_STYLE=!0;var kmlplayer=function(e,i,t,n){function o(e,i){for(var t in i)try{i[t].constructor==Object?e[t]=o(e[t],i[t]):e[t]=i[t]}catch(n){e[t]=i[t]}return e}videojs.options.flash.swf=n||"kmlPlayer/kmlPlayer.swf";var t=t||{},s={techOrder:["html5","flash"],muted:!1,controls:!0,posterImage:!1,autoplay:!1,loop:!1,preload:"auto",errorDisplay:!0,textTrackDisplay:!0,textTrackSettings:!1,controlBar:{audioTrackButton:!1,volumeMenuButton:{vertical:!0,inline:!1},chaptersButton:!1,subtitlesButton:!1,captionsButton:!1,playbackRateMenuButton:!1,customControlSpacer:!1,fullscreenToggle:!!screenfull.enabled,currentTimeDisplay:!1,timeDivider:!1,durationDisplay:!1,liveDisplay:!1,remainingTimeDisplay:!1,descriptionsButton:!1,progressControl:{seekBar:{loadProgressBar:!0,mouseTimeDisplay:!1}}},timeline:{responsive:"scaled",offsetY:-30,width:"full",height:44,font:!1},visibility:{onHidden:function(){},onVisible:function(){}}},i=o(s,i||{});return new videojs(e,i,function(){this.on("ready",function(){this.__readyPlugins||(this.contextmenu("custom"),this.__readyPlugins=!0),"function"==typeof t.ready&&t.ready.call(this)}),this.on("timeupdate",function(){"function"==typeof t.timeupdate&&t.timeupdate.call(this,this.currentTime())}),this.on("volumechange",function(){"function"==typeof t.volumechange&&t.volumechange.call(this,this.volume())}),this.on("seeked",function(){"function"==typeof t.seeked&&t.seeked.call(this,this.currentTime())}),this.on("seeking",function(){"function"==typeof t.seeking&&t.seeking.call(this,this.currentTime())}),this.on("loadedmetadata",function(){this.__loadedPlugins||(this.cuepoints(),this.overlays(),this.scorm&&this.scorm(),i.visibility&&this.visibility({onHidden:i.visibility.onHidden,onVisible:i.visibility.onVisible}),this.__loadedPlugins=!0),i.controlBar&&i.timeline&&("scaled"===i.timeline.responsive?this.controlBar.el_.responsive?this.controlBar.el_.responsive.update({x:0,y:this.videoHeight()-44,width:i.timeline.width,height:i.timeline.height,font:{min:.5,ratio:2}}):(this.addClass("vjs-scaleControlbar"),this.responsive(this.controlBar.el_,{x:0,y:this.videoHeight()-44,width:i.timeline.width,height:i.timeline.height,font:{min:.5,ratio:2}})):i.timeline.responsive&&(this.controlBar.el_.responsive?this.controlBar.el_.responsive.update({x:0,y:i.timeline.y||this.videoHeight(),width:i.timeline.width,offsetY:i.timeline.offsetY,font:i.timeline.font}):this.responsive(this.controlBar.el_,{x:0,y:i.timeline.y||this.videoHeight(),width:i.timeline.width,offsetY:i.timeline.offsetY,font:i.timeline.font}))),"function"==typeof t.loadedmetadata&&t.loadedmetadata.call(this)});for(var e in t)"loadedmetadata"!=e&&"ready"!=e&&"timeupdate"!=e&&"volumechange"!=e&&"seeked"!=e&&"seeking"!=e&&this.on(e,t[e])})};
=======
window.VIDEOJS_NO_DYNAMIC_STYLE=!0;var kmlplayer=function(t,e,i,n){function o(t,e){for(var i in e)try{e[i].constructor==Object?t[i]=o(t[i],e[i]):t[i]=e[i]}catch(n){t[i]=e[i]}return t}videojs.options.flash.swf=n||"kmlPlayer/kmlPlayer.swf";var i=i||{},s={techOrder:["html5","flash"],muted:!1,controls:!0,posterImage:!1,autoplay:!1,loop:!1,preload:"auto",errorDisplay:!0,textTrackDisplay:!0,textTrackSettings:!1,controlBar:{audioTrackButton:!1,volumeMenuButton:{vertical:!0,inline:!1},chaptersButton:!1,subtitlesButton:!1,captionsButton:!1,playbackRateMenuButton:!1,customControlSpacer:!1,fullscreenToggle:!!screenfull.enabled,currentTimeDisplay:!1,timeDivider:!1,durationDisplay:!1,liveDisplay:!1,remainingTimeDisplay:!1,descriptionsButton:!1,progressControl:{seekBar:{loadProgressBar:!0,mouseTimeDisplay:!1}}},timeline:{responsive:"scaled",offsetY:-30,width:"full",height:44,font:!1},visibility:{onHidden:function(){},onVisible:function(){}}},e=o(s,e||{});return new videojs(t,e,function(){this.on("ready",function(){this.__readyPlugins||(this.contextmenu("custom"),this.__readyPlugins=!0),"function"==typeof i.ready&&i.ready.call(this)}),this.on("timeupdate",function(){"function"==typeof i.timeupdate&&i.timeupdate.call(this,this.currentTime())}),this.on("durationchange",function(){"function"==typeof i.durationchange&&i.durationchange.call(this,this.duration())}),this.on("error",function(){"function"==typeof i.error&&i.error.call(this,this.error())}),this.on("volumechange",function(){"function"==typeof i.volumechange&&i.volumechange.call(this,this.volume())}),this.on("seeked",function(){"function"==typeof i.seeked&&i.seeked.call(this,this.currentTime())}),this.on("seeking",function(){"function"==typeof i.seeking&&i.seeking.call(this,this.currentTime())}),this.on("ratechange",function(){"function"==typeof i.ratechange&&i.ratechange.call(this,this.playbackRate())}),this.on("loadedmetadata",function(){this.__loadedPlugins||(this.cuepoints(),this.overlays(),this.scorm&&this.scorm(),e.visibility&&this.visibility({onHidden:e.visibility.onHidden,onVisible:e.visibility.onVisible}),this.__loadedPlugins=!0),e.controlBar&&e.timeline&&("scaled"===e.timeline.responsive?this.controlBar.el_.responsive?this.controlBar.el_.responsive.update({x:0,y:this.videoHeight()-44,width:e.timeline.width,height:e.timeline.height,font:{min:.5,ratio:2}}):(this.addClass("vjs-scaleControlbar"),this.responsive(this.controlBar.el_,{x:0,y:this.videoHeight()-44,width:e.timeline.width,height:e.timeline.height,font:{min:.5,ratio:2}})):e.timeline.responsive&&(this.controlBar.el_.responsive?this.controlBar.el_.responsive.update({x:0,y:e.timeline.y||this.videoHeight(),width:e.timeline.width,offsetY:e.timeline.offsetY,font:e.timeline.font}):this.responsive(this.controlBar.el_,{x:0,y:e.timeline.y||this.videoHeight(),width:e.timeline.width,offsetY:e.timeline.offsetY,font:e.timeline.font}))),"function"==typeof i.loadedmetadata&&i.loadedmetadata.call(this)});for(var t in i)"loadedmetadata"!=t&&"ready"!=t&&"timeupdate"!=t&&"volumechange"!=t&&"seeked"!=t&&"seeking"!=t&&"ratechange"!=t&&"durationchange"!=t&&"error"!=t&&this.on(t,i[t])})};
>>>>>>> origin/master
